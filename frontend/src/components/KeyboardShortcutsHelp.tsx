      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            <button
              onClick={onClose}
              className="mt-6 w-full bg-purple-950/40 hover:bg-purple-950/60 border border-purple-900/30 text-purple-300 font-medium py-2 rounded-xl transition-all text-xs"
            >
              Close Shortcuts
            </button>
          </motion.div>
